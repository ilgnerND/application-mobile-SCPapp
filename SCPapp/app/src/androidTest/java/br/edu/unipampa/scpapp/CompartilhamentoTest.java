...
public class CompartilhamentoTest {
    @Rule
    ...
    public void buscasTest() {
        ...
        appCompatEditText.perform(scrollTo(), replaceText("123456789999999"), closeSoftKeyboard());

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.campo_cont_processo), withText("12345678999999"),
                        withParent(withId(R.id.activity_main))));
        appCompatEditText2.perform(scrollTo(), replaceText("123456789999999"), closeSoftKeyboard());
